...
Note:  If you see "numRelationshipCreateErrors" in your response, this is likely due to the number of relationships that can't be created due to a soft deleted entity.
