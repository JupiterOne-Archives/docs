...
This is easily done via the [API or CLI](./j1-client-and-cli.md). Each entity object can be represented in a few lines of JSON or YAML code. The [J1 API Client or CLI](./j1-client-and-cli.md) can create/update them to your JupiterOne account. You can also develop a script to run on a schedule (e.g. via a cron job) or integrate into your DevOps automation.
