...
Read the [J1QL query tutorial](./tutorial-j1ql.md) and the [complete J1QL documentation](../Jupiterone-Data-Model/jupiterOne-query-language_(J1QL).md) for more advanced examples.
