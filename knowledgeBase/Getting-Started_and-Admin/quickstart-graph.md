...
This documentation focuses on interacting with the graph component. For more details on J1QL, read the [J1QL tutorial](../Jupiterone-Data-Model/tutorial-j1ql.md) and [technical doc](../docs/jupiterone-query-language.md).
