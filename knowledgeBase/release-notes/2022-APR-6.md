...
- New Insights Dashboard - Critical Asset Attack Surface: Insight on your Attack Surface associated with Critical Assets that are indirectly connected to the Internet or allowing access to Everyone.
- New Insights Dashboard - GitHub Insights: Valuable insight into your GitHub accounts including user access, developer activity, collaborator details, information on pull requests, and issue summary by repos.
