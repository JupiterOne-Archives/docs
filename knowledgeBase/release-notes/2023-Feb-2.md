...
- J1QL updates include the ability to:

  -  Perform aggregate math functions in `RETURN` to perform aggregate math functions in the RETURN clause. This update allows you to add math operators such as AVG, SUM, COUNT, and so on to return results more easily. 
  -  Merge on properties within a query to a single list.
